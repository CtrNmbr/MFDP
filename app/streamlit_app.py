...
st.title("🍷 isFraud Prediction App")
...
def predict():
    ...
    id_12 = st.number_input('id_12')
    id_13 = st.number_input('id_13')
    id_14 = st.number_input('id_14')
    id_15 = st.number_input('id_15')
    id_16 = st.number_input('id_16')
    ...
    id_23 = st.number_input('id_23')
    id_24 = st.number_input('id_24')
    id_25 = st.number_input('id_25')
    id_26 = st.number_input('id_26')
    id_27 = st.number_input('id_27')
    id_28 = st.number_input('id_28')
    id_29 = st.number_input('id_29')
    id_30 = st.number_input('id_30')
    id_31 = st.number_input('id_31')
    id_32 = st.number_input('id_32')
    id_33 = st.number_input('id_33')
    id_34 = st.number_input('id_34')
    id_35 = st.number_input('id_35')
    id_36 = st.number_input('id_36')
    id_37 = st.number_input('id_37')
    id_38 = st.number_input('id_38')
    DeviceType = st.number_input('DeviceType')
    DeviceInfo = st.number_input('DeviceInfo')
    TransactionDT = st.number_input('TransactionDT')
    TransactionAmt = st.number_input('TransactionAmt')
    ProductCD = st.number_input('ProductCD')
    card1 = st.number_input('card1')
    card2 = st.number_input('card2')
    card3 = st.number_input('card3')
    card4 = st.number_input('card4')
    card5 = st.number_input('card5')
    card6 = st.number_input('card6')
    addr1 = st.number_input('addr1')
    addr2 = st.number_input('addr2')
    dist1 = st.number_input('dist1')
    dist2 = st.number_input('dist2')
    P_emaildomain = st.number_input('P_emaildomain')
    R_emaildomain = st.number_input('R_emaildomain')
    ...
    M4 = st.number_input('M4')
    M5 = st.number_input('M5')
    M6 = st.number_input('M6')
    M7 = st.number_input('M7')
    M8 = st.number_input('M8')
    M9 = st.number_input('M9')
